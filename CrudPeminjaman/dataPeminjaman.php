        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary box-solid">
            <div class="box-header">
              <h3 class="box-title">DATA PEMINJAMAN PERPUS SMANSABA</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th style="width:20px">Batas Pengembalian</th>
                  <th>Terlambat</th>
                  <th>status</th>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    if ($lambat>0) {
                      echo "
                      <font color='red'>$lambat hari ($denda1)</font>
                      ";
                    }else {
                      echo "$lambat hari";
                  ...
                  <td>
                    <form class="" action="changeStatuskembali.php" method="POST" enctype="multipart/form-data">
                      ...
                      <a href="inputMin.php?kode=<?php echo $data->id_transaksi?>">
